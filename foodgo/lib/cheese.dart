...
class _cheesepageState extends State<cheesepage> {
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Text(
                    "Cheese Wendy's Burger is likely a reference to the popular fast-food chain Wendy's and their signature cheeseburger. A Wendy's cheeseburger typically consists of a beef patty, American cheese, lettuce, tomato, onion, pickles, and ketchup on a toasted bun.",
                    style: TextStyle(
                      fontSize: 17,
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        _getSpicyLabel(spicyLevel), // Yeh line ko yahan rakhein
                        style: TextStyle(
                          fontSize: 18,
                ...
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (context) => CartPage(
                      cartItems: cartItems,
                      onRemoveItem:
                          _removeItemFromCart, // Include the remove function here
                    ),
                  ),
                );
              },
  ...
  String _getSpicyLabel(double? level) {
    if (level == null) {
      return 'Unknown'; // Default value if level is null
    } else if (level <= 3) {
      return 'Low';
    } else if (level <= 7) {
      return 'Mid';
  ...
  Color _getSpicyColor(double? level) {
    if (level == null) {
      return Colors.grey; // Default color if level is null
    } else if (level <= 3) {
      return Colors.green;
    } else if (level <= 7) {

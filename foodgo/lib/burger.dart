    ...
    if (cartData != null) {
      ...
      setState(() {
        _cartQuantity = cartItems.fold(
            ...
            (sum, item) =>
                sum +
                (item['quantity'] as int)); // Cart quantity ko update karo
      });
    }
  }
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Text(
                    "CHamburger Veggie Burger is likely a reference to two different types of burger: Hamburger: A ground beef patty cooked and served on a bun, often with toppings like cheese, lettuce, tomato, onion, pickles, and condiments. Veggie burger.",
                    style: TextStyle(
                      fontSize: 17,
